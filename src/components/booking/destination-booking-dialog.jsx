...
export function DestinationBookingDialog({ open, onOpenChange, destinationSlug, destinationName }) {
            ...
            <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
                <DialogHeader className="pb-6">
                    ...
                    <p className="text-gray-600 font-sans text-base">
                        Interested in <strong className="text-[#0d3980]">{destinationName}</strong>? Fill in the details below and we&apos;ll get back to you with a customized travel plan.
                    </p>
                </DialogHeader>
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-6">
                            ...
                            {/* Additional Details */}
                            <div>
                                <Label htmlFor="message" className="text-[#0d3980] font-semibold font-sans mb-2 block">
                                    Additional Details
                                </Label>
                                <Textarea
                                    id="message"
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <Label htmlFor="adults" className="text-[#0d3980] font-semibold font-sans mb-2 block">
                                        Adults
                                    </Label>
                                    <Input
                                        id="adults"
                                ...
                                <div>
                                    <Label htmlFor="children" className="text-[#0d3980] font-semibold font-sans mb-2 block">
                                        Children
                                    </Label>
                                    <Input
                                        id="children"
