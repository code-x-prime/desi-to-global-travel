...
export function PackageBookingDialog({ open, onOpenChange, packageSlug, packageName }) {
            ...
            <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
                <DialogHeader className="pb-6">
                    ...
                    <p className="text-gray-600 font-sans text-base">
                        Interested in <strong className="text-[#0d3980]">{packageName}</strong>? Fill in the details below and we&apos;ll get back to you with a customized travel plan.
                    </p>
                </DialogHeader>
